...
const CONTRACT_ADDRESS = '0xC5770D8A88c56d7Ed9CFcF28C68cbce5eB30D397';
...
async function main() {
  ...
  try {
    ...
    console.log('\n================================================================');
    console.log('🎉 100% ALL ON-CHAIN TESTS PASSED FOR CONTRACT 0xC5770D8A88c56d7Ed9CFcF28C68cbce5eB30D397!');
    console.log('================================================================\n');
